    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white/10 backdrop-blur-md p-8 rounded-3xl shadow-2xl w-full max-w-md border border-white/20">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl font-bold text-white drop-shadow-lg">Sign Up</h2>
          <div className="w-4 h-4 bg-gradient-to-r from-pink-400 to-purple-400 rounded-full shadow-lg"></div>
        </div>

        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-sm font-semibold mb-2 text-white drop-shadow-sm">Username</label>
            <input
              type="text"
              value={username}
          ...
          <div>
            <label className="block text-sm font-semibold mb-2 text-white drop-shadow-sm">Confirm Password</label>
            <input
              type="password"
